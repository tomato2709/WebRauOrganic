...
*/
        ...
        public ActionResult Dathang(FormCollection collection )
        {
            ...
            var tennguoinhan = collection["NguoiNhan"];
            var diachigiao = collection["DiaChiGiaoHang"];
            var sdtnguoinhan = collection["SDTNguoiNhan"];
            var ghichu = collection["GhiChu"];
            dh.NguoiNhan = tennguoinhan;
            dh.DiaChiGiaoHang = diachigiao;
